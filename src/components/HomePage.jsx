...
const primaryFeatures = [
  {
    description: "Up to 45% off at +350 furniture stores",
    href: "#",
    icon: BoltIcon,
  },
  {
    description: "Concepts from multiple top designers",
    href: "#",
    icon: UsersIcon,
  },
  {
    description: "One-on-one interior design consultation",
    href: "#",
    icon: CalendarDaysIcon,
  },
  {
    description: "3D model  of your space",
    href: "#",
    icon: CalendarDaysIcon,
  },
  {
    description: "Color  palette &  floor plan",
    href: "#",
    icon: CalendarDaysIcon,
  },
];
    ...
    <div className="bg-white">
      ...
      <div className="mx-auto  max-w-7xl  sm:px-6 lg:px-8 mb-8">
        <div className="px-6  lg:px-8">
          <div className="mx-auto max-w-2xl  text-center  mt-11">
            <h1 className="text-2xl font-light tracking-tight text-gray-800 sm:text-5xl">
              How it Works: Our Easy Process
            </h1>
            <p className="my-6 text-pretty text-lg font-light text-gray-600 sm:text-base">
              Choose from unique design concepts from multiple accomplished
              online interior designers
            </p>
          </div>
        </div>
        <div className="relative overflow-hidden px-6 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
          {/* Responsive Video Iframe */}
          <iframe
            src="https://iframe.mediadelivery.net/embed/48637/842ac9f8-9a20-456a-801e-348018a69920?autoplay=true"
            title="YouTube video"
              ...
              {primaryFeatures.map((feature) => (
                ...
                >
                  <dt className="text-base/7 font-semibold text-white">
                    ...
                    <div className="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-[#B19F6F]">
                      {/* Icon Alignment */}
                      <feature.icon
                        aria-hidden="true"
        ...
        <section className="isolate overflow-hidden bg-white px-6 lg:px-8 my-11  w-full shadow-xl">
          <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
            ...
            <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
              <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
                ...
                <blockquote className="text-xl/8 font-semibold text-gray-600 sm:text-2xl/9">
                  <p>
                    “We recommend Decorilla as the best online interior design
                    service due to its comprehensive full-service offerings.”
                  </p>
                </blockquote>
              </div>
              <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
                <img
                  ...
                  className="rounded-xl bg-indigo-50 lg:rounded-full"
                />
              </div>
