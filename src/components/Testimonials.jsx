...
export default function Example() {
  return (
    <div>
      <div className="relative isolate bg-white pb-11 pt-24 sm:pt-32">
        <div
          aria-hidden="true"
        ...
        >
          <div
            ...
            className="ml-[max(50%,38rem)] aspect-[1313/771] w-[82.0625rem] bg-gradient-to-tr from-[#d2ad48] to-[#d0a936]"
          />
        </div>
        <div
          aria-hidden="true"
        ...
        >
          <div
            ...
            className="ml-[-22rem] aspect-[1313/771] w-[82.0625rem] flex-none origin-top-right rotate-[30deg] bg-gradient-to-tr from-[#f0cd6e] to-[#605b4a] xl:ml-0 xl:mr-[calc(50%-12rem)]"
          />
        </div>
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-balance text-4xl font-semibold tracking-tight text-gray-500 sm:text-sm">
              Our customers love our professional virtual interior design
